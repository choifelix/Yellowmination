...
/****************************************************/
/* Classe des personnages actifs		            */
/****************************************************/
class Personnage_actif : public Personnage{
	public:
		// Constructeurs
		Personnage_actif(float x, float y, std::string new_name, int new_team, std::string audio_file,int hp, int atk, int def, float dodge, float radius, float speed , int ult_cooldown, int ult_damage);
		Personnage_actif(float x, float y, std::string new_name, int new_team, std::string audio_file,int hp, int atk, int def, float dodge, float radius, float speed , int ult_cooldown, int ult_damage, int ult_speed,float volume);
		// Methodes
