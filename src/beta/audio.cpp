...
Audio::Audio(std::string audio_file, int team, float volume){
    ...
    // if (!buffer1.loadFromFile(_audio_file))
    //     return;

    // sf::SoundBuffer buffer2;
    // if (!buffer2.loadFromFile(_audio_file))
    //     return;

    // sf::SoundBuffer buffer3;
    // if (!buffer3.loadFromFile(_audio_file))
    //     return;


    //sound_buffers = { sf::SoundBuffer(),sf::SoundBuffer(),sf::SoundBuffer() };
